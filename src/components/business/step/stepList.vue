    ...
    <el-form label-width="80px" inline>
      ...
      >
        ...
        <div style="text-align: right; margin: 0">
          ...
          <el-button type="primary" size="mini" @click="changeStatus(null, 'enable', true)">确定</el-button>
        </div>
        <el-button
          slot="reference"
          :disabled="selectedDataList.length === 0"
      ...
      >
        ...
        <div style="text-align: right; margin: 0">
          ...
          <el-button type="primary" size="mini" @click="changeStatus(null, 'disable', true)">确定</el-button>
        </div>
        <el-button
          slot="reference"
          :disabled="selectedDataList.length === 0"
...
} from '@/apis/uiTest/step'
import { caseFrom as webUiCaseFrom, getCase as webUiGetCase, copyCaseStep as webUiCopyCaseStep } from '@/apis/uiTest/case'
...
} from '@/apis/appTest/step'
import { caseFrom as appUiCaseFrom, getCase as appUiGetCase, copyCaseStep as appUiCopyCaseStep } from '@/apis/appTest/case'
...
export default {
  ...
  methods: {
    ...
    getStepList(case_id) {
      this.tableLoadingIsShow = true
      this.stepListUrl({ 'case_id': case_id || this.caseId }).then(response => {
        this.tableLoadingIsShow = false
