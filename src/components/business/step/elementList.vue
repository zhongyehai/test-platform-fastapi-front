...
import { moduleList as appUiModuleList } from '@/apis/appTest/module'
import { pageList as appUiPageList } from '@/apis/appTest/page'
import { elementList as appUiElementList } from '@/apis/appTest/element'
import { projectList as appUiProjectList } from '@/apis/appTest/project'

import { moduleList as webUiModuleList } from '@/apis/uiTest/module'
import { pageList as webUiPageList } from '@/apis/uiTest/page'
import { elementList as webUiElementList } from '@/apis/uiTest/element'
...
export default {
  ...
  methods: {
    ...
    getModulesByProjectId(project_id) {
      this.moduleListUrl({ 'project_id': project_id, page_num: 1, page_size: 99999 }).then(response => {
