        ...
        <div style="margin-left: 20px">
          ...
          >
            ...
            <el-form-item :label="'负责人'" prop="manager" size="mini" class="is-required">
              <userSelector ref="userSelect" :current-user-list="currentUserList" :user="tempProject.manager" />
            </el-form-item>
...
import { postProject as webUiPostProject, putProject as webUiPutProject } from '@/apis/uiTest/project'
import { postProject as AppPostProject, putProject as AppPutProject } from '@/apis/appTest/project'
import { phoneList } from '@/apis/appTest/device'
