...
import { projectEnvSynchronization as webUiProjectEnvSynchronization } from '@/apis/uiTest/project'
import { projectEnvSynchronization as appProjectEnvSynchronization } from '@/apis/appTest/project'
  ...
  methods: {
    ...
    saveEventSynchronizer() {
      ...
      this.projectEnvSynchronizationUrl({
        ...
        env_from: this.dataSourceFrom,
        env_to: this.dataSourceTo
      }).then(response => {
        this.submitButtonIsLoading = false
