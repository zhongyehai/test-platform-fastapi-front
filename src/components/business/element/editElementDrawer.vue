...
<script>
import { postElement as appPostElement, putElement as appPutElement } from '@/apis/appTest/element'
import { postElement as webUiPostElement, putElement as webUiPutElement } from '@/apis/uiTest/element'
