...
import { getConfigByCode, getExtractsMapping } from '@/apis/config/config'
import {
  apiMsgBelongTo,
  apiMsgBelongToStep,
  // getAssertMapping,
...
export default {
  ...
  methods: {
    ...
    getModuleList(projectId) {
      ...
      this.currentParent = {}
      this.moduleTreeUrl({ page_num: 1, page_size: 99999, project_id: projectId }).then(response => {
