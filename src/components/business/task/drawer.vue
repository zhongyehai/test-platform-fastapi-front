    ...
    <el-form label-width="120px" style="margin-left: 20px;margin-right: 20px">
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="任务信息" name="taskInfo">
          ...
          <el-form-item v-show="tempTask.is_send !== 'not_send'" class="is-required" size="mini" label="接收方式">
...
import { postTask as webUiPostTask, putTask as webUiPutTask, runTask as webUiRunTask } from '@/apis/uiTest/task'
import { caseSuiteList as webUiCaseSuiteList } from '@/apis/uiTest/caseSuite'
import { caseList as webUiCaseList, putCaseIsRun as webUiPutCaseIsRun } from '@/apis/uiTest/case'

import { postTask as appUiPostTask, putTask as appUiPutTask, runTask as appUiRunTask } from '@/apis/appTest/task'
import { caseSuiteList as appUiCaseSuiteList } from '@/apis/appTest/caseSuite'
import { caseList as appUiCaseList, putCaseIsRun as appUiPutCaseIsRun } from '@/apis/appTest/case'
...
export default {
  ...
  methods: {
    ...
    getCaseList(suiteId) {
      ...
      this.caseListUrl({ suite_id: suiteId, status: 1, page_num: 1, page_size: 99999 }).then(response => {
