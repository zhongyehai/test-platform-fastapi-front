        ...
        <el-tabs v-model="reportTab" class="table_padding" style="margin-left: 5px">
          <el-tab-pane label="测试报告列表" :name="reportTab">
            ...
            >
              ...
              <el-table-column show-overflow-tooltip prop="name" align="center" label="任务名称" min-width="18%" />
...
import { getProject as webUiGetProject } from '@/apis/uiTest/project'
import { getCase as webUiGetCase, caseRun as webUiCaseRun } from '@/apis/uiTest/case'
import { caseSuiteRun as webUiRunCaseSuite } from '@/apis/uiTest/caseSuite'
import { runTask as webUiRunTask } from '@/apis/uiTest/task'
import {
  reportList as webUiReportList,
  deleteReport as webUiDeleteReport
} from '@/apis/uiTest/report'

import { getProject as appUiGetProject } from '@/apis/appTest/project'
import { getCase as appUiGetCase, caseRun as appUiCaseRun } from '@/apis/appTest/case'
import { caseSuiteRun as appUiRunCaseSuite } from '@/apis/appTest/caseSuite'
import { runTask as appUiRunTask } from '@/apis/appTest/task'
import {
...
export default {
  ...
  methods: {
    ...
    // 获取用户信息，同步请求
    async getUserList() {
      const response = await userList({ page_num: 1, page_size: 99999 })
